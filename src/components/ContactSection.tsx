...
export default function ContactSection({ className }: { className?: string }) {
  return (
    <section
      className={`w-full bg-gray-900 text-white relative ${className ?? ""}`}
    >
      <div className="relative">
        ...
        >
          <h2 className="text-4xl sm:text-8xl text-4xl font-bold sm:-ml-2 ml-2">
            <span className="typewriter" style={{ ["--n" as any]: 28 }}>
        ...
        <div className="grid md:grid-cols-8 grid-cols-1">
          ...
          >
            <h3 className="text-xl font-medium mb-6">Contact Me</h3>
